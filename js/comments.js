...
import { googleSignIn, watchVisitor } from "./auth.js";
...
function loginPromptHTML(message) {
  return `
    <div class="login-required">
      <p>${message}</p>
      <button type="button" class="btn btn-primary login-prompt-btn">ورود با گوگل</button>
    </div>`;
}

function wireLoginPrompt(container) {
  container.querySelector(".login-prompt-btn")?.addEventListener("click", () => googleSignIn());
}
