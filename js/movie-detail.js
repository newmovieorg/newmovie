...
import {
  fetchComments, renderRatingSummary, renderComments, initCommentForm,
  fetchQuestions, renderQuestions, initQuestionForm
} from "./comments.js";
...
function initReviews(movieId) {
  ...
  initCommentForm({
    movieId,
    starsElId: "commentStars", formElId: "commentForm",
    nameElId: "commentName", textElId: "commentText", submitBtnId: "commentSubmitBtn",
    onSubmitted: () => loadCommentsSection(movieId)
  });

  initQuestionForm({
    movieId,
    formElId: "questionForm",
    nameElId: "questionName", textElId: "questionText", submitBtnId: "questionSubmitBtn",
    onSubmitted: () => loadQuestionsSection(movieId)
  });
}
